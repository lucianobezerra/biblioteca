...
public class FrameReader extends javax.swing.JDialog {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jPanel3.add(rbCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 16, 120, -1));

        bgOrdem.add(rbNome);
        rbNome.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        rbNome.setText("Nome");
        rbNome.setActionCommand("name");
        jPanel3.add(rbNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 16, 120, -1));

        checkOrdem.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        checkOrdem.setText("Inverter");
        jPanel3.add(checkOrdem, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 16, 90, -1));
        ...
        jPanel3.add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 16, 120, -1));
  ...
  private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
    fillGrid(txtPesquisa.getText().toUpperCase(), checkSomenteAtivo.isSelected(), bgOrdem.getSelection().getActionCommand(), checkOrdem.isSelected());
  ...
  private void fillGrid(String name, boolean onlyActive, String ordem, boolean checkOrder) {
    String sql = "select * from readers \nwhere name like '%"+ name +"%'";
           sql += onlyActive ? "\n and active" : "";
           sql += "\norder by " + ordem;
           sql += checkOrder ? " DESC" : " ASC";
    Funcoes.removeLinha(model);
    List<Reader> readers = Reader.findBySQL(sql);

...
public class FrameLoan extends javax.swing.JDialog {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        btFindReader.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/filtrar.gif"))); // NOI18N
        ...
        btFindItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/filtrar.gif"))); // NOI18N
  ...
  private void preencheGrid() {
    ...
    List<Loan> loans = Loan.find("devolution is null").orderBy("created_at DESC");
    for (Loan loan : loans) {
      Reader reader = loan.parent(Reader.class);
      Item item = loan.parent(Item.class);
